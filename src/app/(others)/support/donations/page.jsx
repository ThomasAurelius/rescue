...
const DonationsPage = () => {
	return (
		<section className=" max-w-4xl min-h-screen bg-white p-8 flex items-start justify-center">
			<div className="flex flex-col justify-center  items-center mx-auto px-4 py-8">
				...
				{/* Introductory Text */}
				<p className="flex justify-center items-center text-lg max-w-3xl text-center text-gray-700 mb-6">
					Your generous donation helps cover the operational costs and
					daily care for dogs in foster homes. Every contribution makes a
				...
				<p className="text-lg max-w-3xl text-gray-700 mb-8">
					Thank you for considering a donation. Your support goes a long
					way in helping us provide a safe and loving environment for every
					foster dog.
				</p>
				...
				<div className="text-center bg-teal-50 rounded-lg text-xl text-gray-600 mt-4">
					If you are interested in making a recurring donation, please
					visit our{" "}
					<Link
